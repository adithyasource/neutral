        ...
        <Draggable>
          <div class="moreInfo" style="display: {moreInfoDisplay}">
            ...
            <div style="padding: 15px 20px 0px 20px;  padding-bottom:40px">
              ...
              <a href="https://github.com/adithyasource/neutral" target="_blank"
                >here</a
              > <br /><br />
              ...
              made by
              <a href="https://adithya.zip/" target="_blank">adithya</a>
              <br />
      ...
      <div class="bottomElementsCredit">
        ...
        <div class="rightSide">
          <p class="bottomElementsCredit" style="position: relative;">
            made by ​<u>
              <a href="https://adithya.zip/" target="_blank">adithya</a></u
            >
          </p>
        </div>
      </div>
      ...
      <div id="menuItems" style="display: {showMenuItems};">
        ...
        <div id="shortcutsMenu" style="display: {showShortcuts};">
          <p style="line-height: 1.7em">
            ...
            <i>
              made by <a href="https://adithya.zip/" target="_blank">
                <u>adithya</u>
              </a>
            </i> <br />
            <i>
